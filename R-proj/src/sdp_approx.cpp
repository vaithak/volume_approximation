...
//' @export
// [[Rcpp::export]]
int sdp_approx(Rcpp::Nullable<int> d = R_NilValue,
               Rcpp::Nullable<int> num = R_NilValue,
                             Rcpp::Nullable<double> optimal_sol = R_NilValue,
    ...
    vars <NT, RNGType> var(0, n, 1, 1, 0.0, 0.1, 0, 0.0, 0, InnerB.second, diam_spec, rng, urdist,
                           urdist1,
